  ...
  return (
    <div className="flex max-w-2xl mx-auto shadow border-b">
      <div className="px-8 py-8">
        ...
        <h1 className="text-bold">Update Patient</h1>
        <br></br>
        {/* <div className=" ">
          <form>
              ...
              <input type="text" className="h-50 w-50 border mt-2 px-2 py-2 "></input>
                ...
                <div className="items-center justify-center h-14 w-full my-4">
                        <button className="rounded text-black font-semibold
                                  bg-green-400 border mt-2 px-2 py-2 hover:bg-green-500"
                                  onClick={(e, id) => updatePatient(e, patient.patientId)}>Update</button>
                        <button 
                        onClick={() => navigate("/patientList")}
                        className="rounded text-black font-semibold
                                  bg-red-400 border mt-2 px-2 py-2 hover:bg-red-500 "
                                  >Cancel</button>
